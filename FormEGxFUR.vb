...
#End Region
    ...
    Private Sub ProcesaDiasEnSemanasMasDias()
        ...
        ElseIf EG > 300 Then
            ...
            TextoDeEGenSemanasyDias = "Según esta FUR debería tener más de 43 semanas, revisa FUR..."
            labResultado.Text = TextoDeEGenSemanasyDias
        ...
        Else
            ...
            labResultado.Text = "Según esta FUR tiene " & TextoDeEGenSemanasyDias & " de gestación, la FPP"
            If FPP < Today Then
